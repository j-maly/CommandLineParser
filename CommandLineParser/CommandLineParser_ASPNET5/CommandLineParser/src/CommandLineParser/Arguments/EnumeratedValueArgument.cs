...
namespace CommandLineParser.Arguments
{
    ...
    public sealed class EnumeratedValueArgumentAttribute : ArgumentAttribute
    {
        ...
        public string AllowedValues
        {
            ...
            set
            {
                argumentType.InvokeMethod("InitAllowedValues", Argument, value);
            }
        }
        ...
        public object DefaultValue
        {
            get
            {
                return argumentType.GetPropertyValue<object>("DefaultValue", Argument);
            }
            set
            {
                argumentType.SetPropertyValue("DefaultValue", Argument, value);
            }
        }
    }
}