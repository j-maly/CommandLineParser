...
#pragma warning restore CS0649
    ...
    {
        var commandLineParser = InitDeclarativeArguments();
        string[] args = { "--color", "red", "--version", "1.2" };
        commandLineParser.ParseCommandLine(args);
    }
    ...
    {
        var commandLineParser = InitDeclarativeArguments();
        string[] args = { "-d", "C:\\Input", "-i", "in.txt", "-x", "out.txt" };
        commandLineParser.ParseCommandLine(args);
    }
